...
personalDetails : PersonalDetails
personalDetails =
    { name = "Nicoara Cristian-Catalin"
    , intro = "I like to play football"
    , contacts = [ DetailWithName "email" "cristiano.nicoara@gmail.com" ]
    , socials = [ DetailWithName "https://github.com/octocat/NicoaraCristianCatalin" "https://github.com/octocat" ]
    }
